...
ok("標題留著", out.includes("# Project notes"), out);
...
ok("圖片內嵌保留", out.includes("![[diagram.png]]"), out);
ok("PDF 內嵌保留", out.includes("![[spec.pdf]]"), out);
...
const cases = [
  ...
  ["![[資料夾/note.md]]", "[embedded note: 資料夾/note.md]", ".md 副檔名也算筆記"],
